...
import { fetchProdcutsByFiltersAsync, selectAllItems, selectAllProducts, selectBrands, selectCategory,fetchCategoryAsync, fetchBrandsAsync } from '../../product/productSlice';
                        ...
                        {section.options.map((option, optionIdx) => (
                          <div key={option.value} className="flex items-center">
                            <input
                              ...
                              name={`${section.id}[]`}
                              type="checkbox"
                              // onChange={(e)=>console.log(e,section,option)}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <Link to='/admin/product-form'>
              <button
              type='button'
                  className="flex rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 my-5 mx-9"
      ...
      <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-10"> 
          {product.map((product,index) => (
            ...
            <div  className="group relative border-solid border-2 border-gray-100 p-1.5">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <p className="text-sm block line-through font-medium text-gray-500">${Math.round(product.price)}</p>
                </div>
              </div>
            {product.delete &&
            <div>
            <p className='text-sm text-red-500 my-1.5'>Product deleted</p>
            </div>
            }  
            </div>
            ...
            <Link
                  ...
                  className="flex rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 my-5"
